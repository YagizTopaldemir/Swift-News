...
import { View,Text, SafeAreaView, StatusBar, StyleSheet,Image, Pressable, ScrollView, Modal, Linking, TouchableOpacity, ActivityIndicator, Dimensions } from 'react-native';
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        ...
        sethomefirstnews(response.data.articles[3])
          setLoading(false);
        } catch (error) {
      ...
      <Text><AntDesign name="menuunfold" size={28} color="white" /></Text>
       ...
       <View style={styles.secondNewspart}>
        <View style={{width: '100%',height: 70,overflow: 'hidden',flexDirection: 'row',paddingTop: '5%'}}>
          <Text style={{marginLeft: '8%',fontSize: 19,fontWeight: 700}}>Breaking News</Text>
       ...
       <View style={styles.secondNewspart}>
        <View style={{width: '100%',height: 70,overflow: 'hidden',flexDirection: 'row',paddingTop: '5%'}}>
          <Text style={{marginLeft: '8%',fontSize: 19,fontWeight: 700}}>Technology News</Text>
          <Text style={{position: 'absolute',right: 0,marginRight: '5%',marginTop: '6%',opacity: 0.8,fontWeight: 600}}>More</Text>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} >
          {tecnews.map(item => 
       ...
       <View style={styles.secondNewspart}>
        <View style={{width: '100%',height: 70,overflow: 'hidden',flexDirection: 'row',paddingTop: '5%'}}>
          <Text style={{marginLeft: '8%',fontSize: 19,fontWeight: 700}}>Science News</Text>
          <Text style={{position: 'absolute',right: 0,marginRight: '5%',marginTop: '6%',opacity: 0.8,fontWeight: 600}}>More</Text>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} >
          {spornews.map(item => 
